      ...
      <div className="max-w-[500px]">
        ...
        >
          <div className="flex flex-col gap-y-2">
            <span className="text-[14px] text-[#1D2026]">Current password</span>
          ...
          <div className="flex flex-col gap-y-2">
            <span className="text-[14px] text-[#1D2026]">New password</span>
            <div className="flex items-center gap-x-3 border-[1px] border-[#E9EAF0] px-[18px] py-[11px] text-[14px]">
              <input
                {...register("new")}
          ...
          <div className="flex flex-col gap-y-2">
            <span className="text-[14px] text-[#1D2026]">Confirm password</span>
            <div className="flex items-center gap-x-3 border-[1px] border-[#E9EAF0] px-[18px] py-[11px] text-[14px]">
              <input
                {...register("newConfirm")}
