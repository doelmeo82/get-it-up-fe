      ...
      <div className="p-[24px] max-w-[1000px] mx-auto ">
        <div className="flex justify-between items-center">
          <div>
            ...
            <h1 className="font-semibold text-[20px] text-[#FF6636]">
              {userInfo?.fullname}
            </h1>
          </div>
          <div className="flex items-center gap-x-3">
            <div className="title_learn w-[30px] h-[30px] flex justify-center items-center bg-[#F5F7FA] relative">
              ...
              {dataNoti?.some(
                (item: any, index: number) => item?.status === false
              ) && (
              ...
              <div className="z-10 modal_title_learn absolute top-[100%] right-[30%] w-[350px] h-fit bg-white border-[1px] border-[#272829]">
                <div className="flex flex-col text-[#272829] gap-y-3">
                  <h1 className="text-base font-semibold px-3 py-2 ">
                    Notifications
                  </h1>
                  <div className="divide-y h-full flex overflow-auto flex-col-reverse">
                    {dataNoti?.length === 0 ? (
                      <p className="text-center">
                        Hiện không có Notifications nào
                      </p>
                    ) : (
                      <>
                        {dataNoti?.map((item: any, index: number) => (
                          <div
                            className="px-3 grid grid-cols-[60px_1fr] py-2 relative transition-all duration-200 hover:bg-slate-200"
                            key={index}
                          >
                            <img
            ...
            <div>
              <img
                src={
                  userInfo?.avatar
                    ? userInfo?.avatar
                    : "https://images.pexels.com/photos/17528251/pexels-photo-17528251/free-photo-of-d-i-n-c-s-a-s-c-d-p-ch-p-nh-d-ng-v-t.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                }
                alt=""
