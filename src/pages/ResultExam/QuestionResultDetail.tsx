  ...
  return (
    <div className="">
      <div className="flex items-center gap-x-4">
        <h1 className="font-semibold text-[#FF6636]">Quizz {index + 1}</h1>
      ...
      >
        ...
        <button className="text-[14px] font-medium">View solution</button>
      </div>
      {isOpen && (
        <Fade in={isOpen}>
          <div>
            <div
              className={
                "p-[10px] rounded-lg bg-[#FF6636] mt-[10px] flex flex-col gap-y-[10px]"
              }
            >
